...
//any changes.
  TIMER0->CTL &=~(1U<<0);
//2. Write the GPTM Configuration Register (GPTMCFG) with a value of 0x04. (16 bit half range Timer)
  TIMER0->CFG = 0x04;
...
//5. Load the start value into the GPTM Timer n Interval Load Register (GPTMTnILR).
  //Example: Toggle led 1 sec
  // 64000 counts
  TIMER0->TAILR = 64000U-1;
  // Configure prescaler value with 250
  TIMER0->TAPR = 250U-1;
